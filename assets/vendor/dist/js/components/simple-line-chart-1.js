    ...
    if (chartEl.length) {
      chartEl.each(function() {
            ...
            datasets: [
              {
                ...
                borderWidth: 2,
                borderColor: $(this).data("line-color") !== void 0 ? $(this).data("line-color") : getColor("primary", 0.8),
        ...
        helper.watchCssVariables(
          ...
          (newValues) => {
            simpleLineChart1.data.datasets[0].borderColor = $(el).data("line-color") !== void 0 ? $(el).data("line-color") : getColor("primary", 0.8);
