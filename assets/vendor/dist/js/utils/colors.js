(() => {
      ...
      module.exports = {
        ...
        theme: {
          extend: {
            ...
            backgroundImage: {
              waveform: "url('/src/images/bg-waveform.png')",
              lucent: "url('/src/images/bg-lucent.png')",
          ...
          plugin(function({ addBase }) {
            addBase({
              ...
              ":root": {
                ...
                "--color-info": toRGB(colors2.cyan["600"]),
                "--color-warning": toRGB(colors2.yellow["600"]),
                "--color-pending": toRGB(colors2.orange["700"]),
              ...
              // Theme 1 colors
              ".theme-1": {
                "--color-theme-1": toRGB(colors2.violet["900"]),
                "--color-theme-2": toRGB(colors2.rose["800"]),
                "--color-primary": toRGB(colors2.violet["900"]),
                "--color-secondary": toRGB(colors2.slate["200"]),
                "--color-success": toRGB(colors2.teal["600"]),
                "--color-info": toRGB(colors2.cyan["600"]),
                "--color-warning": toRGB(colors2.yellow["600"]),
                ...
                "--color-dark": toRGB(colors2.slate["800"]),
                "&.dark": {
                  "--color-primary": toRGB(colors2.sky["800"])
                }
              },
              // Theme 2 colors
              ".theme-2": {
                "--color-theme-1": toRGB(colors2.purple["900"]),
                "--color-theme-2": toRGB(colors2.cyan["700"]),
                "--color-primary": toRGB(colors2.purple["900"]),
                "--color-secondary": toRGB(colors2.slate["200"]),
                "--color-success": toRGB(colors2.teal["600"]),
                "--color-info": toRGB(colors2.cyan["600"]),
                "--color-warning": toRGB(colors2.yellow["600"]),
              ...
              // Theme 3 colors
              ".theme-3": {
                "--color-theme-1": toRGB(colors2.cyan["700"]),
                "--color-theme-2": toRGB(colors2.violet["800"]),
                "--color-primary": toRGB(colors2.cyan["700"]),
                "--color-secondary": toRGB(colors2.slate["200"]),
                "--color-success": toRGB(colors2.teal["600"]),
                "--color-info": toRGB(colors2.cyan["600"]),
                "--color-warning": toRGB(colors2.yellow["600"]),
              ...
              // Theme 4 colors
              ".theme-4": {
                "--color-theme-1": toRGB(colors2.sky["700"]),
                "--color-theme-2": toRGB(colors2.rose["800"]),
                "--color-primary": toRGB(colors2.sky["700"]),
                "--color-secondary": toRGB(colors2.slate["200"]),
                "--color-success": toRGB(colors2.teal["600"]),
                "--color-info": toRGB(colors2.cyan["600"]),
                "--color-warning": toRGB(colors2.yellow["600"]),
              ...
              // Theme 5 colors
              ".theme-5": {
                "--color-theme-1": toRGB(colors2.sky["800"]),
                "--color-theme-2": toRGB(colors2.emerald["800"]),
                "--color-primary": toRGB(colors2.sky["800"]),
                "--color-secondary": toRGB(colors2.slate["200"]),
                "--color-success": toRGB(colors2.teal["600"]),
                "--color-info": toRGB(colors2.cyan["600"]),
              ...
              // Theme 7 colors
              ".theme-7": {
                "--color-theme-1": toRGB(colors2.lime["950"]),
                "--color-theme-2": toRGB(colors2.teal["900"]),
                "--color-primary": toRGB(colors2.lime["950"]),
                "--color-secondary": toRGB(colors2.slate["200"]),
                "--color-success": toRGB(colors2.teal["600"]),
                "--color-info": toRGB(colors2.cyan["600"]),
                "--color-warning": toRGB(colors2.yellow["600"]),
              ...
              ".theme-10": {
                ...
                "--color-primary": toRGB(colors2.indigo["800"]),
                "--color-secondary": toRGB(colors2.slate["200"]),
                "--color-success": toRGB(colors2.teal["600"]),
                "--color-info": toRGB(colors2.cyan["600"]),
                "--color-warning": toRGB(colors2.yellow["600"]),
              ...
              // Theme 16 colors
              ".theme-16": {
                "--color-theme-1": toRGB(colors2.sky["900"]),
                "--color-theme-2": toRGB(colors2.blue["950"]),
                "--color-primary": toRGB(colors2.sky["900"]),
                "--color-secondary": toRGB(colors2.slate["200"]),
                "--color-success": toRGB(colors2.teal["600"]),
                "--color-info": toRGB(colors2.cyan["600"]),
                "--color-warning": toRGB(colors2.yellow["600"]),
              ...
              // Theme 17 colors
              ".theme-17": {
                "--color-theme-1": toRGB(colors2.slate["900"]),
                "--color-theme-2": toRGB(colors2.slate["800"]),
                "--color-primary": toRGB(colors2.slate["900"]),
                "--color-secondary": toRGB(colors2.slate["200"]),
                "--color-success": toRGB(colors2.teal["600"]),
                "--color-info": toRGB(colors2.cyan["600"]),
                "--color-warning": toRGB(colors2.yellow["600"]),
  ...
  var helpers = {
    ...
    watchCssVariables(element, variableNames, callback) {
      const targetElement = typeof element === "string" ? document.querySelector(element) : element;
      const observer = new MutationObserver(() => {
        const computedStyle = getComputedStyle(targetElement);
        const variableValues = variableNames.reduce(
          (values, variableName) => {
            values[variableName] = computedStyle.getPropertyValue(`--${variableName}`).trim();
            return values;
          },
          {}
        );
      ...
      const initialValues = variableNames.reduce((values, variableName) => {
        values[variableName] = getComputedStyle(targetElement).getPropertyValue(`--${variableName}`).trim();
        return values;
      }, {});
