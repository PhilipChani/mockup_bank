defmodule MockupBank.Database.WalletAccounts do
  @moduledoc """
  ...
  def changeset(user_account, attrs) do
    user_account
    |> cast(attrs, [:customer_number, :nickname, :account_users_id, :account_number, :balance, :currency, :account_type, :status, :last_transaction_date])
