defmodule MockupBank.Service.WalletService do
  # Import necessary modules and aliases
  alias MockupBank.Repo
  alias MockupBank.Database.{AccountUsers, Transaction}
  alias MockupBank.Database.WalletAccounts, as: UserAccounts
  import Ecto.Query
